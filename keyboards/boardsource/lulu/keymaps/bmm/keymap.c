...
[_SYM_NAV] = LAYOUT(
  _______  , KC_1    , KC_2    , KC_3       , KC_4       , KC_5       ,                         KC_6    , KC_7     , KC_8    , KC_9    , KC_0  , _______ ,
  _______ , S(KC_1) , S(KC_2) , S(KC_LBRC) , S(KC_RBRC) , S(KC_QUOT) ,                         _______ , KC_BSLS , _______ , _______ , KC_MUTE, _______ ,
  _______ , S(KC_3) , S(KC_6) , S(KC_9)    , S(KC_0)    , KC_QUOT    ,                         _______ , _______ , _______ , _______ , KC_VOLU, _______ ,
  _______ , S(KC_5) , S(KC_4) , KC_LBRC    , KC_RBRC    , KC_GRV     , _______ ,     _______ , _______  , _______ , _______ , _______ , KC_VOLD, _______ ,
